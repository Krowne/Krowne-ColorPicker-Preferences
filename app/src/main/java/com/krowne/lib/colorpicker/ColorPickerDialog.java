...
public class ColorPickerDialog extends Dialog implements com.krowne.lib.colorpicker.ColorPickerView.OnColorChangedListener, View.OnClickListener {
	private com.krowne.lib.colorpicker.ColorPickerView mColorPicker;
	private com.krowne.lib.colorpicker.ColorPickerPanelView mOldColor;
	private com.krowne.lib.colorpicker.ColorPickerPanelView mNewColor;
	...
	private void setUp(int color) {
		...
		mColorPicker = (com.krowne.lib.colorpicker.ColorPickerView) layout.findViewById(R.id.color_picker_view);
		mOldColor = (com.krowne.lib.colorpicker.ColorPickerPanelView) layout.findViewById(R.id.old_color_panel);
		mNewColor = (com.krowne.lib.colorpicker.ColorPickerPanelView) layout.findViewById(R.id.new_color_panel);
			...
			public void afterTextChanged(Editable s) {
				if (mHexValueEnabled) {
					...
					if (s.length() > 5 || s.length() < 10) {
						try {
							int c = com.krowne.lib.colorpicker.ColorPickerPreference.convertToColorInt(s.toString());
